...
from rse_motion_models.motion_models import velocity_motion_model_linearized
from rse_observation_models.observation_models import odometry_observation_model_linearized
...
class TestJacobians(unittest.TestCase):
    ...
    def setUp(self):
        ...
        _, self.G_np, self.V_np = velocity_motion_model_linearized() 
