...
# from .filters.kalman_filter_odom_model import KalmanFilter 
from .filters.ekf_acc_and_odom_imu_1 import KalmanFilter 

class KalmanFilterNode(Node):
    def __init__(self):
        super().__init__('kalman_filter_node')

        print("Initializing extended_kalman_filter_acc_model_odom_imu")
    ...
    def odom_raw_callback(self, msg):
        ...
        self.u = np.asarray([msg.twist.twist.linear.x + 0.1, msg.twist.twist.angular.z]) 
        ...
        z =  np.array([[self.normalized_pose[0]], [self.normalized_pose[1]], [self.normalized_pose[2]], [self.normalized_imu_theta], [self.imu_w], [self.imu_a_x], [self.imu_a_y]])
